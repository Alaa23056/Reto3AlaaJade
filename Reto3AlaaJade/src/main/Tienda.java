...
public class Tienda {
	...
	/*
	 * Pedidos: se mostrará el siguiente submenú 3
	 * 
	 * .1. Crear pedido: pediremos el código de un cliente hasta que exista,
	 ...
	 * precio total. 3.2. Ver pedidos: mostraremos todos los pedidos del mes en el
	 * que estamos *
	 * 
	 */

	public static PedidoProducto crearPedido(Scanner sc) {

		PedidoProducto pedidoPro = null;

		return pedidoPro;
	}

	public static Clientes pedirCliente(Scanner sc) {
		Clientes clienteEscogido = null;

		do {

			int idcliente = Funciones.dimeEntero("Introduce id cliente", sc);
